...
/**
 * Classe principale exécutée au lancement de l'application
 */
public class MainActivity extends AppCompatActivity implements ICalculView {
    ...
    /**
     * Classe de chargement au lancement de l'application
     *
    ...
    /**
     * Méthode qui permet l'affichage des éléments de résultat de l'application
     *
     * @param image
     * @param img
     * @param message
    ...
    /**
     * Méthode qui permet de remplir les champs
     *
     * @param poids
     * @param taille
     * @param age
